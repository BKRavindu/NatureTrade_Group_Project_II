            ...
            <div className="flex flex-col flex-1 mr-3">
                ...
                <div className="flex gap-3-p-4 rounded-lg bg-white shadow-lg mt-4 p-10 gap-14 mr-4">
                    ...
                    <div className="flex flex-col gap-10 justify-center m-5">
                        <div className="font-semibold text-3xl">John Nicholas</div>
                        <div className="text-xl font-semibold text-green-600 px-6 py-1 text-2xl bg-blue-100 rounded-lg inline-block self-center -ml-45">Delivery partner</div>
...
<div className="flex justify-between items-end m-3 -mt-1 mb-8">
    <div className="font-normal text-lg w-1/3">John Nicholas</div>
    <div className="font-normal text-lg w-1/3 text-center">(+94) 077-1234567</div>
    <div className="font-normal text-lg w-1/3 text-center ml-15">Jnicholas69@naturetrade.com</div>
</div>
