      ...
      <div className="flex">
        ...
        <div className="flex flex-col flex-1 mr-3">
          ...
          <div className="flex flex-col gap-3-p-4 rounded-lg bg-white shadow-md mt-4 p-10 gap-5 mr-4 justify-center items-center">
            <div className="flex text-3xl font-semibold">Choose the Type</div>
            <div className="flex border-2 border-sky-900 justify-center items-center p-0.5">
              <div className="flex w-44 h-10 justify-center items-center text-xl bg-sky-200 text-sky-900 cursor-pointer">
                Bid
              </div>
              <Link to="/Collector/CollectorTender">
              <div className="flex w-44 h-10 justify-center items-center text-xl cursor-pointer">
                Tenders
              </div>
              </Link>
            </div>
            <div className="flex justify-center items-center border rounded-lg p-2 pr-4 pl-4 cursor-pointer bg-[#D3E7F0] text-[#034F75] hover:bg-[#034F75] hover:text-white "><i className='bx bx-edit pr-3' ></i>Start a Bid</div>
          </div>
          <div className="flex flex-col gap-3-p-4 rounded-lg bg-white shadow-md mt-4 p-10 gap-5 mr-4 justify-center items-center">
                      ...
                      <div className="my-6" key={data.id}>
                        <div className="flex flex-col gap-4 shadow-lg py-8 px-6 mx-4 rounded-xl bg-[#F8F9FD] relative">
                          ...
                          <div className="flex flex-col items-center gap-4">
                            ...
                            <div className="flex justify-center items-center border rounded-lg p-2 pr-4 pl-4 cursor-pointer bg-[#D3E7F0] text-[#034F75] hover:bg-[#034F75] hover:text-white "><i className='bx bx-edit pr-3' ></i>Edit Bit</div>
                          </div>
