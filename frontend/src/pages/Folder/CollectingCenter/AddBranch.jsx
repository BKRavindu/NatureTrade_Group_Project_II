        ...
        <div className="flex">
            ...
            <div className="flex flex-col flex-1 ">
                <div className="flex flex-col">
                    <div className="font-semibold text-xl mb-2 -mt-12 mb-5">Add New Branch</div>
                    <div className="flex flex-row gap-3">


                        <div className="font-normal text-gray-400 text-md">Branches</div>{">"}

                        <div className="font-normal text-md">Add New Branch</div>
                    </div>
                </div>
                <div className="flex flex-col gap-2 mt-3 mr-3 bg-white shadow-lg rounded-md">
                    <div className="flex justify-between p-3 mr-3">
                        <div className="flex flex-col gap-2 ml-3 mt-3">
                            <div className="font-semibold text-lg">Branch Info</div>
                            <div className="font-normal text-md text-gray-400">Insert profile photo and details here.</div>
                        </div>
                    ...
                    <div className="flex flex-col justify-between p-4 mr-3 mt-6 gap-2 ">
                            ...
                            <div className="flex gap-10 w-full justify-between border-b border-gray-100 p-5  bb-2">
                                <div className="flex">
                                    <div className="font-normal text-lg">Manager Name</div>
                                </div>
                                <div className="flex justify-end gap-10">

                                    <div className="flex gap-5 p-1 rounded-md  items-center justify-start  w-[300px] border border-2 border-gray bb-2">
                                        <input type="text" placeholder="Name" className="ml-2 border-none focus:outline-none text-gray-500 font-light " value={"First Name"} />
                                    </div>
                                    <div className="flex gap-5 p-1 rounded-md  items-center justify-start  w-[300px] border border-2 border-gray bb-2">
                                        <input type="text" placeholder="Name" className="ml-2 border-none  focus:outline-none text-gray-500 font-light " value={"Last Name"} />
                                    </div>
                                </div>
                            </div>
                            <div className="flex gap-2 justify-between w-full border-b border-gray-100 p-4">
                                <div className="flex w-[750px]">
                                    <div className="font-normal text-lg  ">City</div>
                                </div>
                                <div className="flex justify-end gap-10  w-full">
                                    <div className="flex gap-5 p-1 rounded-md  items-center justify-start  w-[300px] border border-2 border-gray bb-2 w-full">
                                        <input type="text" placeholder="Name" className="ml-2 border-none  focus:outline-none text-gray-500 font-light w-full " value={"Location"} />
                                    </div>
                                </div>
                            </div>
                            <div className="flex gap-2 justify-between w-full border-b border-gray-100 p-4">
                                ...
                                <div className="flex justify-end gap-10 w-full">
                                    ...
                                    <div className="flex gap-5 p-1 rounded-md  items-center justify-start w-full  w-[300px] border border-2 border-gray bb-2">
                                        <input type="text" placeholder="Name" className="ml-2 border-none w-full  focus:outline-none text-gray-500 font-light " value={"Address"} />
                                    </div>
                                </div>
                            </div>
                            <div className="flex gap-2 justify-between w-full border-b border-gray-100 p-4">
                    ...
                    <div className="flex justify-between m-3 p-3 items-center">
                        <div className="flex gap-2 items-start flex-col">
                            <div className="font-normal text-lg">Profile Photo</div>
                            <div className="font-light text-md">This photo will be displayed on your branch profile</div>
                        </div>
