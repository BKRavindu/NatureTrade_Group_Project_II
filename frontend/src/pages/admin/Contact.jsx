        ...
        <div className="flex">
            ...
            <div className="flex flex-col flex-1 ml-[250px]">
                <div className="flex flex-col">
                    <div className="font-semibold text-2xl mb-2 -mt-12 mb-5">Contact</div>
                    <div className="flex flex-row gap-3">

                        <div className="font-normal text-gray-400 text-xl">Dashboard</div>{">"}
                        <div className="font-normal text-xl">Contact</div>
                    </div>
                </div>
                <div className="flex flex-col gap-3 bg-white my-7 mx-7 p-5 rounded-lg shadow-lg p-8 pt-5">
                    ...
                    <table className='mr-1'>
                        <tr className='font-semibold font-center '>
                            ...
                            <th className='px-6 py-3  text-lg font-semibold '>Date & Time</th>
                            <th className='px-6 py-3  text-lg font-semibold '>Description</th>
                        ...
                        <tbody className='font-light text-center'>
                            <tr className='bg-white hover:bg-gray-50 border-b border-gray-100 whitespace-nowrap'>
                                ...
                                <td className='px-8 py-5 text-lg'>Interested in purchasing</td>
                                <td className='px-8 py-5 text-lg'><Link to="/Admin/Contact/Chat"><i className='bx bx-message-rounded-dots text-gray-500 text-2xl'></i></Link></td>
                            </tr>
                            <tr className='bg-white hover:bg-gray-50 border-b border-gray-100 whitespace-nowrap'>
                                ...
                                <td className='px-8 py-5 text-lg'>Need assistance with</td>
                                <td className='px-8 py-5 text-lg'><Link to="/Admin/Contact/Chat"><i className='bx bx-message-rounded-dots text-gray-500 text-2xl'></i></Link></td>
                            </tr>
                            <tr className='bg-white hover:bg-gray-50 border-b border-gray-100 whitespace-nowrap'>
                                ...
                                <td className='px-8 py-5 text-lg'>Seeking advice on improving</td>
                                <td className='px-8 py-5 text-lg'><Link to="/Admin/Contact/Chat"><i className='bx bx-message-rounded-dots text-gray-500 text-2xl'></i></Link></td>
                            </tr>
                            <tr className='bg-white hover:bg-gray-50 border-b border-gray-100 whitespace-nowrap'>
                                ...
                                <td className='px-8 py-5 text-lg'>I have a query about</td>
                                <td className='px-8 py-5 text-lg'><Link to="/Admin/Contact/Chat"><i className='bx bx-message-rounded-dots text-gray-500 text-2xl'></i></Link></td>
                            </tr>
                            <tr className='bg-white hover:bg-gray-50 border-b border-gray-100 whitespace-nowrap'>
                                ...
                                <td className='px-8 py-5 text-lg'>Facing issues with</td>
                                <td className='px-8 py-5 text-lg'><Link to="/Admin/Contact/Chat"><i className='bx bx-message-rounded-dots text-gray-500 text-2xl'></i></Link></td>
                            </tr>
                        </tbody>
