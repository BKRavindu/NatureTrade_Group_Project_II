        ...
        <div className="flex">
            ...
            <div className="flex flex-col flex-1 mr-3 ml-[250px]">
                <div className="flex flex-col">
                    <div className="font-semibold text-xl mb-2 -mt-12 mb-5">View User</div>
                    <div className="flex flex-row gap-3">

                        <div className="font-normal text-gray-400 text-md">Dashboard</div>{">"}
                        <div className="font-normal text-gray-400 text-md">Users</div>{">"}
                        <div className="font-normal text-md">View User</div>
                    </div>
                </div>
                <div className="flex gap-3-p-4 rounded-lg bg-white shadow-md mt-4 p-10 gap-14 mr-4">
                    ...
                    <div className="flex flex-col gap-3 justify-center m-5">
                        ...
                        <div className="text-md font-normal text-blue-500 px-4 py-1 bg-blue-100 rounded-lg inline-block self-center -ml-40">Seller</div>
