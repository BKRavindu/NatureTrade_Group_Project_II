            ...
            <div className="flex flex-col flex-1 mr-3">
                <div className="flex flex-col">
                    ...
                    <div className="flex flex-row gap-3">
                        ...
                        <div className="font-normal text-gray-400 text-md">Profile</div>{">"}
                ...
                <div className="flex gap-3-p-4 rounded-lg bg-white shadow-md mt-4 p-10 gap-14 mr-4">
                    ...
                    <div className="flex flex-col gap-3 justify-center m-5">
                        ...
                        <div className="flex gap-2 items-center justify-start">
                            <div className="text-sm font-normal px-3 py-1 border border-gray-300 rounded-lg">Edit Profile</div>
                            <div className="text-sm font-normal px-3 py-1 border border-gray-300 rounded-lg"><i className='bx bx-phone-call mr-1 self-center items-center ' ></i>Delete Account</div>
                        </div>
                    </div>
