        ...
        <div className='flex'>
            ...
            <div className='flex p-2 flex-col flex-1'>
                <div className="flex flex-col">
                    <div className="font-semibold text-xl  -mt-12 mb-5">Suppliers</div>
            ...
            <div className="flex flex-col gap-3 bg-white my-7 p-5 rounded-lg shadow-lg">
                    ...
                    <table className=''>
                        <tr className='font-semibold font-center '>
                            <th className='px-6 py-3  text-sm font-semibold '>Supplier ID</th>
                            <th className='px-6 py-3  text-sm font-semibold '>Name</th>
                            <th className='px-6 py-3  text-sm font-semibold '>Email</th>
                            <th className='px-6 py-3  text-sm font-semibold '>Contact Number</th>
                            <th className='px-6 py-3  text-sm font-semibold '>Location</th>
                            <th className='px-6 py-3  text-sm font-semibold '>Products</th>
                        ...
                        <tbody className='font-light text-center'>
                            <tr className='bg-white hover:bg-gray-50 border-b border-gray-100'>
                                <td className='px-4 py-3 text-sm  '>S-007</td>
                                <td className='px-4 py-3 text-sm'>John Doe</td>
                                <td className='px-4 py-3 text-sm'>johndoe@gmail.com</td>
                                <td className='px-4 py-3 text-sm'>077-431-4590</td>
                                <td className='px-4 py-3 text-sm'>Kandy</td>
                                <td className='px-4 py-3 text-sm'>Cinnamon, Chiili</td>
                                <td className='flex justify-center px-4 py-3 text-sm'><Link to="/Collector/CollectorSuppliers/ViewSupplier"><FiEye className='m-2 cursor-pointer'/></Link><FiPhoneCall  className='m-2 cursor-pointer'/></td>
                            </tr>
                            <tr className='bg-white hover:bg-gray-50 border-b border-gray-100'>
                                <td className='px-4 py-3 text-sm  '>S-007</td>
                                <td className='px-4 py-3 text-sm'>John Doe</td>
